...
output_dir=/hb/home/omoosman/owen/zoarcoidei/analysis/trimmed_hi_c/$name

# Create output directory if it doesn't exist
mkdir -p $output_dir

# Define the list of input files
read1=/hb/home/omoosman/owen/zoarcoidei/data/hi_c/$name/"${id}_1.fastq.gz"
read2=/hb/home/omoosman/owen/zoarcoidei/data/hi_c/$name/"${id}_2.fastq.gz"

# Run Trim Galore
trim_galore --illumina --fastqc --fastqc_args "--nogroup --outdir $output_dir" --output_dir $output_dir --paired $read1 $read2
